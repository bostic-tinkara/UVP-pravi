...
# =============================================================================
def ekvivalenca(a, b):
    if implikacija(a,b) == implikacija(b,a):
        return True
    else:
        return False
# =====================================================================@000917=
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5MTQsInVzZXIiOjEwNjY2fQ:1tmur4:Opq6zFLNbPbcITiMKAawSGRh83w0WS21KH2yaU9SP7A"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5MjAsInVzZXIiOjEwNjY2fQ:1tmur4:rHzCtnQWvtJ4uskA5nGwRAF8Hqa6JI1DbNs__k3fnoQ"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5MTUsInVzZXIiOjEwNjY2fQ:1tmur4:R1OLRmtNG4IJ0c8nXrhfbBYef39iV2jCbja2J5C-WI8"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5MTYsInVzZXIiOjEwNjY2fQ:1tmur4:e08exAoJQq5XHK_lNWm7UzOIVmaoIQeJM8sqWVKVx9c"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5MTcsInVzZXIiOjEwNjY2fQ:1tmur4:YZ5yUPOjOopyOIasAzphxmL-wG0m2puqOsSkmwBDkrE"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5MTgsInVzZXIiOjEwNjY2fQ:1tmur4:vLWoH9IDc2i9HQpV7jN03qNHWgosIhLyUr7oNezEP4Y"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5MTksInVzZXIiOjEwNjY2fQ:1tmur4:FQMlW9eM-X24Ox0QXwWaaEdjA5XHUI0bS3Ez-UOgQVU"
        try:
